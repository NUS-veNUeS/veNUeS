...
import difflib
from venues import LOCATIONS, VENUES, VENUES_LIST, LOCATIONKEYS
...
TIME = datetime(2022, 1, 12, 10, 0, 0)
NUM_RESULTS = 10
...
def process_room(message):
  ...
  #   reply = "Please specify a venue after the /room command"
  #   bot.reply_to(message, reply)
  #   return

  # room = message_text.split()[1].upper()
  chat_id = message.chat.id
  ...
  if room not in VENUES:
    ...
    for match in matches:
      button = InlineKeyboardButton(text=match, callback_data=f'venue ' + match)
